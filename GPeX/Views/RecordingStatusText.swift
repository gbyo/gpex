...
extension RecordingProblem {
    ...
    var detail: String {
        ...
        case .permissionDenied:
            "GPeX needs location access while recording so photos can be matched to positions."
        case .permissionRestricted:
            "Location access is restricted on this iPhone."
        case .insufficientlyInUse:
            "iOS stopped location updates for GPeX. Open GPeX and start a new recording."
        ...
        case .storageFailure(let description):
            "GPeX could not write to its database. \(description)"
        }
    }
